...
(function(Ajv) {
  ...
  var old_exemplar_schema = require('../../examples/schemas/exemplar-entity/old-exemplar.json');
  ...
  test('exemplar_schema_data_01', old_exemplar_schema, exemplar_schema_data_01);
  test('exemplar_schema_data_02', old_exemplar_schema, exemplar_schema_data_02);
